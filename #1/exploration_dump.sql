CREATE DATABASE  IF NOT EXISTS `exploration` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `exploration`;
...
CREATE TABLE `connections` (
  `cn_from` int(11) NOT NULL,
  `cn_to` int(11) NOT NULL,
...
CREATE TABLE `library_in_json` (
  `lij_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `shopping` (
  ...
  `sh_transaction` int(10) unsigned NOT NULL,
...
CREATE TABLE `site_pages` (
  ...
  `sp_parent` int(10) unsigned DEFAULT NULL,
...
CREATE TABLE `test_counts` (
  ...
  `fni` int(11) DEFAULT NULL,
  `fwi` int(11) DEFAULT NULL,
  `fni_nn` int(11) NOT NULL,
  `fwi_nn` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_fwi` (`fwi`),
...
-- Dump completed on 2022-09-18 16:08:50
